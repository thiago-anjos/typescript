...
var checkForEmail = function (input) {
    if (!isEmail_1.default(input.value)) {
        showErrorMessage(input, 'E-mail inválido');
    }
};
var checkPasswords = function (password, password2) {
...
var showErrorMessage = function (input, msg) {
...
var sendForm = function (form) {
    ...
    form
        .querySelectorAll('.' + SHOW_ERROR_MESSAGES)
        .forEach(function () { return (shouldSend = false); });
    return shouldSend;
};
